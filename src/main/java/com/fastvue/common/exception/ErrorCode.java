package com.fastvue.common.exception;
...
public enum ErrorCode {
    ...
    TENANT_DISABLED(403, "租户已停用或已过期"),
    DEPARTMENT_NOT_FOUND(404, "部门不存在"),
    PROJECT_NOT_FOUND(404, "项目不存在"),
    TASK_NOT_FOUND(404, "任务不存在"),
    APPROVAL_NOT_FOUND(404, "审批不存在"),
    ILLEGAL_STATE_TRANSITION(409, "非法状态转换"),
    OPTIMISTIC_LOCK_CONFLICT(409, "数据已被其他请求修改，请刷新后重试"),
    IDEMPOTENCY_CONFLICT(409, "相同幂等键的请求正在处理或已处理"),
    RATE_LIMITED(429, "请求过于频繁，请稍后重试"),
    FILE_REJECTED(400, "文件不符合上传规则");
